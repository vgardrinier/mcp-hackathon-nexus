...
**Common Issues:**
- `localStorage` errors → Node.js 25 issue, use `'use client'` directive
- OAuth failures → Check redirect URIs match
- Tool not appearing → Check end server is connected
- Auth errors → Verify tokens are valid/not expired
